...
![Azure Container Apps](./media/6-deploy-container-apps.png "Azure Container Apps")
...
1. Open the VS Code command pallet (`shift + cmd + p` on Mac | `shift + ctrl + p` on Windows), and select **Azure Functions: Create Function App in Azure**.
    ...
    ![Create Function App in Azure](./media/automate-data-azure-functions-power-automate/create-function-app-in-azure.png "Create Function App in Azure")
