Provides the ability to return a list of the minimal permission scopes required for requests sent to Microsoft Graph that have been recorded by the proxy. 
