...
* __Changes data, infrastructure, and other back-end considerations.__ If you are using multiple external data sources surfaced via plugin or connectors, ensure that the plugins and connectors you choose can handle the volume of your data. Begin with what is already available in the [Microsoft Graph connectors gallery](/microsoftsearch/connectors-gallery), though more data heavy solutions may entail some code modification and back-end design to meet your specifications.
