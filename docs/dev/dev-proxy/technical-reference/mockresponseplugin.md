...
<!-- WORKS-WITH: MockGeneratorPlugin, LatencyPlugin, AuthPlugin -->
<!-- USE-WHEN: Mocking non-Microsoft Graph APIs -->
...
```json
{
  "$schema": "https://raw.githubusercontent.com/dotnet/dev-proxy/main/schemas/v3.3.0/mockresponseplugin.mocksfile.schema.json",
  "mocks": [
    {
      "request": {
