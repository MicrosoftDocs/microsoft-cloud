...
:::image type="content" source="../media/microsoft-graph-random-error.png" alt-text="Dev Proxy simulating a random error for a Microsoft Graph request" lightbox="../media/microsoft-graph-random-error.png":::
