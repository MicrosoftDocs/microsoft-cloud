...
```json
{
  ...
  "mockResponsePlugin": {
    "$schema": "https://raw.githubusercontent.com/dotnet/dev-proxy/main/schemas/v3.3.0/mockresponseplugin.schema.json",
...
```json
{
  ...
  "latencyPlugin": {
    "$schema": "https://raw.githubusercontent.com/dotnet/dev-proxy/main/schemas/v3.3.0/latencyplugin.schema.json",
    "minMs": 200,
    "maxMs": 10000
  }
}
