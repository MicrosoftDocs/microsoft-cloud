...
```json
{
  ...
  "contosoNotification": {
    "$schema": "https://raw.githubusercontent.com/dotnet/dev-proxy/main/schemas/v3.1.0/mockrequestplugin.schema.json",
...
```json
{
  "$schema": "https://raw.githubusercontent.com/dotnet/dev-proxy/main/schemas/v3.1.0/mockrequestplugin.mockfile.schema.json",
  "request": {
