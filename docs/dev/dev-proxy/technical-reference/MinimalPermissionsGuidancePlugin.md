...
:::image type="content" source="../media/microsoft-graph-minimal-permissions-guidance.png" alt-text="Dev Proxy showing minimal permissions for a set of Microsoft Graph API requests" lightbox="../media/microsoft-graph-minimal-permissions-guidance.png":::
