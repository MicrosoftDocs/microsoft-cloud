...
1. Add the following content to the file:
   ...
   **File:** prices.json
   ...
   ```json
   {
     "$schema": "https://raw.githubusercontent.com/dotnet/dev-proxy/main/schemas/v3.3.0/openaitelemetryplugin.pricesfile.schema.json",
     "prices": {
       "o4-mini": {
         "input": 0.97,
         "output": 3.87
   ...
   **File:** devproxyrc.json (complete with cost tracking)
   ...
   ```json
   {
     ...
     "openAITelemetryPlugin": {
       "$schema": "https://raw.githubusercontent.com/dotnet/dev-proxy/main/schemas/v3.3.0/openaitelemetryplugin.schema.json",
       "includeCosts": true,
