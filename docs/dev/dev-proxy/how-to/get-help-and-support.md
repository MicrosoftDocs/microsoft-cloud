...
<!-- INTENT: Get assistance with Dev Proxy -->
<!-- SOLUTION: Use GitHub issues, discussions, or documentation -->
<!-- RESULT: Get answers to questions or report bugs -->
<!-- PLUGINS: none -->
<!-- JOB: troubleshoot -->
<!-- TIME: 5 minutes -->
...
> **At a glance**  
> **Goal:** Get assistance with Dev Proxy  
> **Time:** 5 minutes  
> **Plugins:** None  
...
- [Dev Proxy GitHub repository](https://github.com/dotnet/dev-proxy)
- [Dev Proxy documentation](../overview.md)
- [Troubleshooting guide](./no-requests-intercepted.md)
